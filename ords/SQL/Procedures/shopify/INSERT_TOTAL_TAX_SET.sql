--------------------------------------------------------
--  DDL for Procedure INSERT_TOTAL_TAX_SET
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MW_ECOMMERCE"."INSERT_TOTAL_TAX_SET" 
(
  P_BODY_TEXT IN CLOB 
) AS 
BEGIN
INSERT INTO sp_total_tax_set
